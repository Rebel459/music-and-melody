...
public class Event {
    ...
    public Event(ResourceLocation source, CategoryType category, SafeIdentifier music, List<Condition> conditions, PriorityType priority, boolean sustain, boolean constant, int weight) {
        this.source = source;
